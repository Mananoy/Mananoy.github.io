...
function drawSpreadsheetChart() {   
   ...
   <!--Set Query-->
   <!--For Rent EventCount-->
   query.setQuery("select Name, '01 Rent EventCount', '02 Rent EventCount', '03 Rent EventCount', '04 Rent EventCount', '05 Rent EventCount', '06 Rent EventCount', '07 Rent EventCount', '08 Rent EventCount', '09 Rent EventCount', '10 Rent EventCount', '11 Rent EventCount', '12 Rent EventCount' where C = 'Braidwood' ");
