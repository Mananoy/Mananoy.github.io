...
<script>
    ...
    function selectSuburb(feature) {
      ...
      <!--Set Query-->
      <!--For Rent EventCount-->
      query.setQuery("select B, `Forrest` where A contains 'Rent EventCount'");
      <!--send query and handle response-->
      query.send(handleQueryResponse);
      <!--handler function-->
      function handleQueryResponse(response) {
      ...
      <!--Set Query-->
      <!--For Rent EventCount-->
      query.setQuery("select B, `Forrest` where A contains 'Rent AveragePrice'");
      <!--send query and handle response-->
      query.send(handleQueryResponse);
      <!--handler function-->
      function handleQueryResponse(response) {
      ...
      <!--Set Query-->
      <!--For Rent EventCount-->
      query.setQuery("select B, `Forrest` where A contains 'Sold EventCount'");
      <!--send query and handle response-->
      query.send(handleQueryResponse);
      <!--handler function-->
      function handleQueryResponse(response) {
      ...
      <!--Set Query-->
      <!--For Rent EventCount-->
      query.setQuery("select B, `Forrest` where A contains 'Sold AveragePrice'");
      <!--send query and handle response-->
      query.send(handleQueryResponse);
      <!--handler function-->
      function handleQueryResponse(response) {
